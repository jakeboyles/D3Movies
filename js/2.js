       ...
       var div = d3.select("#chart").append("div")   
        ...
        svg.selectAll("circle")
			...
			div.transition()        
                ...
                .style("opacity", .9)
                .style("z-index",2000);      
                div .html("<a href='#' class='close'>Close</a>  <h2>"+d.title+"</h2><img src='"+d.posters.thumbnail+"' /><p>"+cons+"</p> <a class='buyName' href='#' name='"+d.title+"'>Buy</a> Audience: "+d.ratings.audience_score+"<br /> Critic: "+d.ratings.critics_score)  
